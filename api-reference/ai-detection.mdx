...
api: POST https://text.api.pangram.com/v3
---

<Badge color="green">Current</Badge>

<Update label="V3 API" description="Current version">
...
<ResponseField name="windows" type="array">
  List of text segments (<Tooltip tip="The text is divided into overlapping segments (windows) that are each classified independently, enabling granular detection across long documents.">windows</Tooltip>) analyzed individually.
