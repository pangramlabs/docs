...
description: "Legacy AI detection endpoints replaced by the async inference API"
---

<Warning>
All endpoints on this page are legacy AI detection endpoints. Use the current [async AI detection API](/api-reference/ai-detection) instead.
</Warning>
